...
You need MySQL and an environment such as Insomnia. Clone the repository, then open MySQL and run the schema. Run the seeds in your terminal, then start your server. 